...
export default function LeafDesigner() {
    ...
    return (
        <div className="w-full md:w-[80%] m-auto py-16">
            <div className={`flex flex-col gap-4 ${started && 'hidden'}`}>
                ...
                <button className='btn rounded-lg transition-all duration-150 hover:brightness-125' onClick={() => setStarted(true)}>Get started</button>
            </div>
